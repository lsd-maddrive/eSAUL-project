...
namespace gazebo
{
  ...
  class GZ_PLUGIN_VISIBLE SimpleTrackedVehiclePlugin : public TrackedVehiclePlugin
  {
  protected:
    ros::NodeHandle n_;
  ...
  private:
    ...
    public:
      explicit ContactIterator(bool _initialized);

    public:
      ContactIterator(const ContactIterator &_rhs);

    public:
      ContactIterator(dBodyID _body, dGeomID _geom1, dGeomID _geom2);
    ...
    public:
      bool operator==(const ContactIterator &_rhs);

    public:
      ContactIterator &operator=(const ContactIterator &_rhs);

    public:
      ContactIterator operator++(int _unused);
